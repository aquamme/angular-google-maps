...
| Package                               | Downloads                                                                                                                                         |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| @ajqua/core                             | [![@ajqua/core](https://img.shields.io/npm/dm/@ajqua/core.svg)](https://www.npmjs.com/package/@ajqua/core)                                              |
| @ajqua/snazzy-info-window               | [![@ajqua/snazzy-info-window](https://img.shields.io/npm/dm/@ajqua/snazzy-info-window.svg)](https://www.npmjs.com/package/@ajqua/snazzy-info-window)    |
| @ajqua/js-marker-clusterer              | [![@ajqua/js-marker-clusterer](https://img.shields.io/npm/dm/@ajqua/js-marker-clusterer.svg)](https://www.npmjs.com/package/@ajqua/js-marker-clusterer) |
---
